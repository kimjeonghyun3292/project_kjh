...
<body>
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form action="joinPro.jsp" method="post" class="login100-form validate-form" name="fr">
				...
				<button type="button" class="btn btn-danger dup" style="height:45px !important; " onclick="winopen();">ID중복체크</button>
					...
					<div class="wrap-input100 validate-input m-b-18" data-validate = "생년월일 필수 입력">
						...
						<input class="input100" type="text" name="birthday" placeholder="예) 19900505">
						<span class="focus-input100"></span>
					</div>
					
					<div class="wrap-input100 validate-input m-b-18">
						<span class="label-input100">성별</span>
						<input class="input110" type="radio" name="gender" value="남">남
						<input class="input110" type="radio" name="gender" value="여">여<br><br>
						<span class="label-input100"></span>
					</div>
					
					<div class="wrap-input100 validate-input m-b-18" data-validate = "연락처 필수 입력">
						<span class="label-input100">연락처</span>
						<input class="input100" type="text" name="phone" placeholder="띄워쓰기 없이 숫자만 기입해주세요">
						<span class="focus-input100"></span>
					</div>
					...
					<div class="wrap-input100 validate-input m-b-18" data-validate = "주소 필수 입력">
						...
						<input class="input100" type="text" id="zip" name="zip" placeholder="우편번호 검색을 통해 입력" >
						<input class="input100" type="text" id="addr1" name="addr1" placeholder="우편번호 검색을 통해 입력" >
            ...
            oncomplete: function(data) {
                ...
                document.getElementById('addr2').focus();
					...
					<div class="wrap-input100 validate-input m-b-18" data-validate = "참여행사 필수 입력">
						...
						<input class="input100" type="text" name="event"  placeholder="박람회, 컨퍼런스, 포럼 등">
						<span class="focus-input100"></span>
					</div>
	...
	<script type="text/javascript">
       function winopen() {
    	 ...
    	 window.open("idCheck.jsp?userid=" + id, "", "width=400, height=200"); 
