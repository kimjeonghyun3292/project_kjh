...
<div class="container">
  ...
  <form action="updatePro.jsp?pageNum=<%=pageNum %>" method="post" name="update">
    <div class="form-group">
      <input type="hidden" class="form-control" id="bno" name="bno" value="<%=bb.getBno() %>">
      <label for="name">작성자:</label>
      <input type="text" class="form-control" id="name" name="name" value="<%=bb.getName() %>" readonly>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="subject" name="subject" value="<%=bb.getSubject() %>">
    </div>
    <div class="form-group">
      <label for="comment">내용:</label>
      <textarea class="form-control" rows="15" id="comment" name="content"><%=bb.getContent() %></textarea>
    </div>
