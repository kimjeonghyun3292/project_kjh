...
<body>
 ...
 <%
  ...
  //   String subject = "";
     ...
     ab.setName(multi.getParameter("name"));
     ab.setPasswd(multi.getParameter("passwd"));
     ab.setSubject(multi.getParameter("subject"));
     ab.setContent(multi.getParameter("content"));
     ...
     // 서버에 저장되는 파일 이름
     ab.setFile(multi.getFilesystemName(file1));
     System.out.println("filename : " + filename);
     
     // 원래 파일이름
     ab.setFile(multi.getOriginalFileName(file1));
...
//   String filename = "";
    ...
    File file = new File(uploadPath + "/sm_" + ab.getFile());
