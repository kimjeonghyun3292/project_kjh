...
<div class="container">
  ...
  <form action="updatePro.jsp?pageNum=<%=pageNum %>" method="post" name="update">
    <div class="form-group">
      <input type="hidden" class="form-control" id="bno" name="bno" value="<%=ab.getBno() %>">
      <label for="name">작성자:</label>
      <input type="text" class="form-control" id="name" name="name" value="<%=ab.getName() %>" readonly>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="subject" name="subject" value="<%=ab.getSubject() %>">
    </div>
    <div class="form-group">
      <label for="comment">내용:</label>
      <textarea class="form-control" rows="15" id="comment" name="content"><%=ab.getContent() %></textarea>
    </div>
   <div class="form-group">
      <label for="file">파일업로드:</label>
      <input type="file" class="form-control" id="file" name="file" value="<%=ab.getFile() %>">
    </div>
    <input type="submit" class="btn btn-default" value="수정">
    <a class="btn btn-default" href="boardList.jsp">취소</a>
  </form>
