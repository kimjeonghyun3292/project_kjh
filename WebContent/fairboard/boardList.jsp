...
// 끝 행번호 계산 (10, 20, 30, 40..)
 ...
 if(cnt != 0){
	// boardList = fdao.getBoardList();
	 ...
	 boardList = adao.getBoardList(startRow, pageSize);
 }
 ...
 <h2>박람회/페어</h2>
  ...
  <br>
    ...
    <thead>
	  ...
	  FairBoardBean ab = (FairBoardBean)boardList.get(i);
    ...
    <div class="box" style="width:1000px;">
	   ...
	   <a href="content.jsp?bno=<%=ab.getBno() %>&pageNum=<%=pageNum %>"><img src = "../upload/<%=ab.getFile() %>" 
	     style="width:215px; height:215px;"></a>
	    <a href="content.jsp?bno=<%=ab.getBno() %>&pageNum=<%=pageNum %>" style="font-size:14px"><%=ab.getSubject() %></a>
   </div>
  ...
  <%--       <% 
        ...
        <% 
          ...
          %>  --%>
      <%--   <a href="content.jsp?bno=<%=ab.getBno()%>&pageNum=<%=pageNum%>"><%=ab.getSubject() %></a>--%>
